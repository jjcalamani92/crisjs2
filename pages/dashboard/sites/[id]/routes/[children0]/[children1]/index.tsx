...
import { CHILDREN_0, CHILDREN_1, CHILDREN_2 } from '../../../../../../../src/graphql/query/site.query';
...
const Children1: FC<Props> = ({ site, sites }) => {
  const { query } = useRouter()
  const { data, isValidating, error } = useSWR([CHILDREN_2, {_id: query.id, input: {children_uid_0: query.children0, children_uid_1: query.children1}}])
...
export const getStaticPaths: GetStaticPaths = async (ctx) => {
  ...
  return {
    paths:[{ params: {id: '62dbf1074609d5227df4baef', children0: 'ropa', children1: 'hombre' } }],
    fallback: 'blocking'
  };
}
